...
def update_order(db: Session, wfm_id: str, subs_id: str, nama_customer: str, account_name: str, produk: str, order_id: str, crm_order_type: str, agreement_name: str, location: str, pic_am: str, sid: int, treg: str, witel: str, divisi: str, segment: str, durasi_berlangganan: str, nilai_revenue: int, revenue_per_bulan: int, order_created_date: int, no_order_astinet: str, upload_dokumen: str, document: bool, activate_account: bool, activation_date: int, input_ip: bool, link_dashboard: str, username: str, password: str, auth_netmonk_hi: str, draft_bast: str, bast_upload_date: int, status_bast: str, status_internal_netmonk_teknis: str, status_internal_netmonk_admin: str, order_closing_date: int, order_status: str, li_milestone: str, tgl_fbc: int):
